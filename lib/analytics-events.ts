...
import { AnalyticsPlatform, detectPlatform } from '@/lib/platform-detection'
import type { AnalyticsPlatformValue } from '@/lib/platform-detection'
...
export { AnalyticsPlatform, detectPlatform } from '@/lib/platform-detection'
