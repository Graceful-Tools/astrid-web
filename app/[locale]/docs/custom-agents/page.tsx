...
export default function CustomAgentsDocsPage() {
      ...
      <div className="theme-header theme-border app-header">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-1 theme-count-bg rounded-full px-3 py-1">
            ...
            <span className="text-sm theme-text-primary">Custom Agent Docs</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-2 sm:p-4">
        <div className="max-w-sm sm:max-w-4xl mx-auto space-y-4 sm:space-y-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold theme-text-primary">Custom Agent Protocol</h1>
          ...
          <Card className="theme-bg-secondary theme-border">
            <CardHeader>
              <CardTitle className="theme-text-primary flex items-center space-x-2">
                ...
                <span>What are Custom Agents?</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm theme-text-secondary">
              <p>
                The Custom Agent protocol connects an AI runtime you operate to {BRAND.appName}. Your agent gets a
              ...
              <p>
                The <code className="mx-1 px-1.5 py-0.5 theme-bg-tertiary rounded text-xs font-mono">.oc@</code>
                suffix is retained as an internal compatibility key. Existing identities and
                OpenClaw channel configurations continue to work without changes.
              </p>
              <p>
          ...
          <Card className="theme-bg-secondary theme-border">
            ...
            <CardContent className="space-y-4 text-sm">
              <Step n={1} title="Register your agent">
                Go to <strong>Settings &rarr; Agents &rarr; Custom Agents &rarr; Connect Agent</strong>.
