 ...
 *
 * Register a Custom Agent identity. The compatibility phase continues to create
 * a {name}.oc@<agent domain> user and OAuth client credentials for the agent.
 *
...
import { customAgentEmail } from '@/lib/brand/agent-emails'
...
export const POST = withAuth(
  { tag: 'v1.custom-agents.register', capability: 'integrationCustomAgents' },
  async (req, auth) => {
    ...
    const agentEmail = customAgentEmail(name)
