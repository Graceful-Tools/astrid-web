 ...
 *
 * The four deployment reads appear here AND in the operator set above. Being
 * read-only lets them through the GET gate; being operator-credentialed still
 * requires a platform admin. Both rules apply.
 */
