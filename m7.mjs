...
for(let i=0;i<32;i++){
  ...
  if(a.executionProgress==='COMPLETE' && (a.sourceCommit?.commitSha||'').startsWith('2153c6d')){
    console.log('#'+a.number+' (2153c6d: kinds+auto-sync+avatar+recursion) => '+a.completionStatus);
