...
> This is the authored canonical workflow for Astrid work. Repository-local agent files
> (`AGENTS.md`, `CLAUDE.md`, etc.) may add platform commands and safety rules,
> but must not weaken or duplicate this process.
>
> **Editing this file?** `public/ASTRID_WORKFLOW.md` is the copy users download from
> Settings → Coding Integration. Mirror any change there — only the banner differs.
